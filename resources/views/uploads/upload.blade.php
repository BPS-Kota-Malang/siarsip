...
@section('body')
                            ...
                            <div class="table-responsive">
                                        ...
                                        @if ($count > 0)
                                            @foreach ($dataUpload as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="edit-button" data-bs-toggle="modal"
                                                            data-bs-target="#edit-file{{ $data->id }}"
                                                            data-id="{{ $data->id }}" data-activity=""
                                                            data-preview-link="{{ $data->preview_link }}"
                                                            data-download-link="{{ $data->download_link }}">
                                ...
                                <a href="{{ route('delete-file',$data->id) }}">
                                    <i class="fas fa-trash-alt" style="color: red"></i>
                                                ...
                                                <div class="modal fade center-modal" id="edit-file" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="preview_link" name="preview_link"
                                        required="" value="{{ $data->preview_link }}">
                                    <div class="invalid-feedback">
    ...
    <!-- Modal Add-->
    <div class="modal fade center-modal" id="add-file" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
